...
function openFile(file: File) {
	if (file._meta.type == 'mol') {
		router.push({ name: 'molviewer' })
	} else if (file._meta.type == 'data') {
		router.push({ name: 'dataviewer' })
	} else if (file._meta.type == 'json') {
		router.push({ name: 'jsonviewer' })
	} else if (file._meta.type == 'text') {
		router.push({ name: 'textviewer' })
	}
	// alert('file')
	// console.log(file)
}
